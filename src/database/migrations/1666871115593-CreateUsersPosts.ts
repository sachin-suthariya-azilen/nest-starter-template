...
export class CreateUsersPosts1666871115593 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE INDEX "IDX_852036802b135c3f93089c8513" ON "post" ("uuid") `);
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP INDEX "public"."IDX_852036802b135c3f93089c8513"`);
